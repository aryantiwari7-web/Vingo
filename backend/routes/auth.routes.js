...
const { signUP, signIn, signOut, ForgotPassword, sendOtp, VerifyOtp, ResetPass, item, addItem,showItem, allShop, cartItem, cartUpdate} = require("../controllers/auth.controllers.js");
...
app1.post("/cartItem:itemId", cartItem);
app1.post("/updateCart", cartUpdate);
